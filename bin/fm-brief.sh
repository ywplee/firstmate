...
3. Use gh-axi for GitHub operations, chrome-devtools-axi for browser operations, and xcrun simctl for real iOS Simulator access on mobile UI work; do not assume simulator or device access is unavailable - see docs/mobile-simulator-access.md.
